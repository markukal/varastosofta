...
module.exports = 

    {
        register: async function (req, res) {
            ...
            connection.query('INSERT INTO kayttajat (luokkaID, kayttajatunnus, salasana, kayttoOikeus) VALUES ("' + luokkaID + '", "'+ kayttajatunnus + '", "' + hashedPassword + '", "' + kayttoOikeus + '")', function(error, results, fields) {
                if (error) {
